...
<div class="gallery-grid">
  ...
  <div class="gallery-card">
    <p class="gallery-title">🌋 Yellowstone (WY/MT/ID)</p>
    <div class="placeholder">Photos coming soon</div>
    <p class="gallery-note">Geysers, bison, and wide-open skies.</p>
  </div>
  ...
  <div class="gallery-card">
    ...
    <div class="placeholder">Photos coming soon</div>
    <p class="gallery-note">Rim trails and golden hour.</p>
  </div>

  <div class="gallery-card">
    <p class="gallery-title">🧗 Yosemite (CA)</p>
